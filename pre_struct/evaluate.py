...
if _USE_SW:
    ...
    from pre_struct.slide_window.test_ebqa import (
...
def run_evaluation(
    ...
    cfg = PredictConfig(model_dir=resolve_model_dir(cfgd))
    cfg.tokenizer_name = resolve_tokenizer_name(cfgd)
    cfg.report_struct_path = resolve_report_struct_path(cfgd)
