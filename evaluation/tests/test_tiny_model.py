#!/usr/bin/env python3
"""
Test the smallest BERT model for similarity calculation.
"""
...
def test_tiny_model():
    print("Testing tiny BERT model for similarity calculation...")
    
    # Create calculator with the smallest model
    calculator = ChineseMedicalSimilarity(model_name="tiny", load_model=True)
    ...
    print("Medical Term Similarities (Tiny BERT model):")
